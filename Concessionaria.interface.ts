...
/*
*  interfaces funcionam como um contrato, para dizer como uma determinada classe
* deve implementar seus metodos.
*  A interface por sua vez ela apenas relaciona quais métodos devem ser implementados,
* mas não diz como, logo a classe que implementa essa interface tem a obrigação
* de dizer como esse método vai se comportar
*
